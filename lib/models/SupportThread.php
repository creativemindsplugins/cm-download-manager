...
Click to see: [comment_link]';
    ...
    public static function processNotificationTitleSetting($params = array()) {
        if (!empty($_POST[self::OPTION_THREAD_NOTIFICATION_TITLE]) AND CMDM_BaseController::canSaveSettings()) {
            update_option(self::OPTION_THREAD_NOTIFICATION_TITLE, sanitize_text_field($_POST[self::OPTION_THREAD_NOTIFICATION_TITLE]));
        }
    ...
    public static function processNotificationMessageSetting($params = array()) {
        if ( !empty($_POST[self::OPTION_THREAD_NOTIFICATION]) AND CMDM_BaseController::canSaveSettings() ) {
            update_option(self::OPTION_THREAD_NOTIFICATION, sanitize_text_field($_POST[self::OPTION_THREAD_NOTIFICATION]));
        }
    ...
    public static function processNewNotificationTitleSetting($params = array()) {
        if ( !empty($_POST[self::OPTION_NEW_THREAD_NOTIFICATION_TITLE]) AND CMDM_BaseController::canSaveSettings() ) {
            update_option(self::OPTION_NEW_THREAD_NOTIFICATION_TITLE, sanitize_text_field($_POST[self::OPTION_NEW_THREAD_NOTIFICATION_TITLE]));
        }
    ...
    public static function processNewNotificationMessageSetting($params = array()) {
        if ( !empty($_POST[self::OPTION_NEW_THREAD_NOTIFICATION]) AND CMDM_BaseController::canSaveSettings() ) {
            update_option(self::OPTION_NEW_THREAD_NOTIFICATION, sanitize_text_field($_POST[self::OPTION_NEW_THREAD_NOTIFICATION]));
        }
